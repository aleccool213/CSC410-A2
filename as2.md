...
====================================================== search started: 30/11/16 11:48 AM

====================================================== Method Summaries
Inputs: x_1_SYMINT,y_CONCRETE,

nl.tudelft.jpacman.board.Board.withinBorders(0,2)  --> Return Value: 1
nl.tudelft.jpacman.board.Board.withinBorders(2,2)  --> Return Value: 0
nl.tudelft.jpacman.board.Board.withinBorders(-1000000,2)  --> Return Value: 0
...
<table border=1>
<tr><td>x_1_SYMINT</td><td>y_CONCRETE</td><td>RETURN</td></tr>
<tr><td>0</td><td>2</td><td>Return Value: 1</td></tr>
<tr><td>2</td><td>2</td><td>Return Value: 0</td></tr>
<tr><td>-1000000</td><td>2</td><td>Return Value: 0</td></tr>
</table>
...
heap:               new=484,released=173,maxLive=476,gcCycles=5
instructions:       5282
max memory:         123MB
loaded code:        classes=77,methods=1681

====================================================== search finished: 30/11/16 11:49 AM
```
